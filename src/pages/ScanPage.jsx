...
const ScanPage = () => {
  ...
  const handleScanSuccess = async (data) => {
    try {
      ...
      if (data.type.toLowerCase() === "store") {
        ...
        const res = await StoreService.startStoreSession({ storeId: data.ID });
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
      ...
      <p>Position a store or product QR code within the frame to scan.  67aedf17f3de451a67f976e1</p>
